    ...
    async def _send_kf_text(
        ...
        if data.get("errcode") != 0:
            ...
            if errcode == 95001:
                ...
                logger.debug("微信客服95018(session invalid), user=%s", external_userid)
            else:
